...
<body>
<main class="card"><div class="top"></div><section class="content"><div class="code">419</div><h1>Sesión expirada</h1><p>Por seguridad, la sesión expiró. Vuelve a intentar la operación.</p><div class="actions"><a href="{{ route('login') }}" class="btn btn-primary">Iniciar sesión</a></div></section></main>
</body>
</html>

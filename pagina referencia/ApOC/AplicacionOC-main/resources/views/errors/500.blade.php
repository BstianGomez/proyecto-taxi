...
<body>
<main class="card"><div class="top"></div><section class="content"><div class="code">500</div><h1>Ocurrió un error inesperado</h1><p>Algo falló en el sistema. Intenta nuevamente en unos minutos.</p><div class="actions"><a href="{{ route('oc.index') }}" class="btn btn-primary">Ir al inicio</a><a href="{{ url()->previous() }}" class="btn btn-secondary">Volver</a></div></section></main>
</body>
</html>
